...
class BatchStrategy: TrackingStrategy {

}

class ForceTrackStrategy: TrackingStrategy {
...
class TrackerTest: XCTestCase {
    ...
    func applicationJSON() -> [String:Any] {
        let obj: [String:Any] = [
            "public_key": MPXTracker.sharedInstance.getPublicKey(),
            "checkout_version": MPXTracker.sharedInstance.getSdkVersion(),
            "platform": "native/ios"
        ]
        return obj
    }
